...
# -*- coding: utf-8 -*-
"""
Tool: Bootstrap - Công cụ bootstrap cho dự án

Mục đích: Wrapper Python cho shell script bootstrap
...
SCRIPT_FILE = SCRIPT_DIR / "bootstrap.sh"
...
def main():
    """Hàm chính - Chạy bootstrap script"""
    if not SCRIPT_FILE.exists():
        print(f"\n❌ Không tìm thấy file bootstrap.sh!")
