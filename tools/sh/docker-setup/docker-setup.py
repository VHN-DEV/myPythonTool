...
# -*- coding: utf-8 -*-
"""
Tool: Docker Setup - Cài đặt và cấu hình Docker

Mục đích: Wrapper Python cho shell script docker-setup
...
SCRIPT_FILE = SCRIPT_DIR / "docker-setup.sh"
...
def main():
    """Hàm chính - Chạy docker-setup script"""
    if not SCRIPT_FILE.exists():
        print(f"\n❌ Không tìm thấy file docker-setup.sh!")
