...
# -*- coding: utf-8 -*-
"""
Tool: WordPress Auto Install - Tự động cài đặt WordPress

Mục đích: Wrapper Python cho shell script wordpress_auto_install
...
SCRIPT_FILE = SCRIPT_DIR / "wordpress_auto_install.sh"
...
def main():
    """Hàm chính - Chạy wordpress_auto_install script"""
    if not SCRIPT_FILE.exists():
        print(f"\n❌ Không tìm thấy file wordpress_auto_install.sh!")
    ...
    try:
        ...
        # Chạy script
        print(f"\n🚀 Đang chạy wordpress_auto_install.sh...\n")
        print_separator("-")
