...
# -*- coding: utf-8 -*-
"""
Tool: Optimize Image - Tối ưu hóa hình ảnh

Mục đích: Wrapper Python cho shell script optimize-image
...
SCRIPT_FILE = SCRIPT_DIR / "optimize-image.sh"
...
def main():
    """Hàm chính - Chạy optimize-image script"""
    if not SCRIPT_FILE.exists():
        print(f"\n❌ Không tìm thấy file optimize-image.sh!")
