...
# -*- coding: utf-8 -*-
"""
Tool: Search Replace - Tìm và thay thế chuỗi trong file

Mục đích: Wrapper Python cho shell script search-replace
...
SCRIPT_FILE = SCRIPT_DIR / "search-replace.sh"
...
def main():
    """Hàm chính - Chạy search-replace script"""
    if not SCRIPT_FILE.exists():
        print(f"\n❌ Không tìm thấy file search-replace.sh!")
