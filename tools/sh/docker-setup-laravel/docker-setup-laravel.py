...
# -*- coding: utf-8 -*-
"""
Tool: Docker Setup Laravel - Cài đặt Docker cho dự án Laravel

Mục đích: Wrapper Python cho shell script docker-setup-laravel
...
SCRIPT_FILE = SCRIPT_DIR / "docker-setup-laravel.sh"
...
def main():
    """Hàm chính - Chạy docker-setup-laravel script"""
    if not SCRIPT_FILE.exists():
        print(f"\n❌ Không tìm thấy file docker-setup-laravel.sh!")
    ...
    try:
        ...
        # Chạy script
        print(f"\n🚀 Đang chạy docker-setup-laravel.sh...\n")
        print_separator("-")
